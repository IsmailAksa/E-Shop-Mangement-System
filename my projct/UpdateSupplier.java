	...
	public void actionPerformed(ActionEvent ae)
	{
      if(ae.getSource()==b0)
      {
		...
		System.out.println("Connected to database.");
         ps=con.prepareStatement("select * from supply where sid='"+t1.getText()+"' or sname='"+t2.getText()+"'");
	      rs=ps.executeQuery();
		  while(rs.next())
	      {
...
String str1="UPDATE supply SET sid='"+t1.getText()+"',sname='"+t2.getText()+"',sadress='"+t3.getText()+"',sphoneno='"+t4.getText()+"',semailid='"+t5.getText()+"' where sid='"+t1.getText()+"' or sname='"+t2.getText()+"' ";
